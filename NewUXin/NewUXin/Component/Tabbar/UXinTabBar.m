...
{
    UXinTabBarItem *tabBarItem = [[UXinTabBarItem alloc] initWithItemImageRatio:self.itemImageRatio];
...
- (void)buttonClick:(UXinTabBarItem *)tabBarItem
{
...
-(void)layoutSubviews
{
    ...
    for (NSInteger index = 0; index < count; index++) {
        ...
        UXinTabBarItem *tabBarItem = self.tabBarItems[index];
