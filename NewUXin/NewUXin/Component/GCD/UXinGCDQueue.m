...
#import "UXinGCDQueue.h"
#import "UXinGCDGroup.h"
static UXinGCDQueue *mainQueue;
static UXinGCDQueue *globalQueue;
static UXinGCDQueue *highPriorityGlobalQueue;
static UXinGCDQueue *lowPriorityGlobalQueue;
static UXinGCDQueue *backgroundPriorityGlobalQueue;
@implementation UXinGCDQueue
...
+(void)initialize
{
     ...
     */
    if (self == [UXinGCDQueue self])  {
        
        mainQueue                     = [UXinGCDQueue new];
        globalQueue                   = [UXinGCDQueue new];
        highPriorityGlobalQueue       = [UXinGCDQueue new];
        lowPriorityGlobalQueue        = [UXinGCDQueue new];
        backgroundPriorityGlobalQueue = [UXinGCDQueue new];
